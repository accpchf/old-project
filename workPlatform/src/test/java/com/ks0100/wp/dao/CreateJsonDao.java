...
import com.ks0100.common.constant.create_enums.CreateStatusJson;
import com.ks0100.common.constant.create_enums.Status;
import com.ks0100.wp.test.spring.SpringContextTestCase;

@ContextConfiguration(locations = { "/spring/applicationContext.xml" })
public class CreateJsonDao extends SpringContextTestCase{
	@Autowired
...
/*	     for(Status s:list){
	     ...
	     CreateStatusJson.createStatusJson(list, 
	    		 "D:\\eclipse_workspace\\innovation\\workPlatform\\src\\main\\webapp\\static\\script\\common\\status.js");
	}
